...
-- Requerimientos: Comdb Existente

ALTER TABLE "dbo"."smtp_server"
	DROP CONSTRAINT "FK_smtp_mx_result_smtp_domain"
GO
ALTER TABLE "dbo"."smtp_result"
	DROP CONSTRAINT "FK_smtp_result_smtp_server"
GO
ALTER TABLE "dbo"."smtp_result"
	DROP CONSTRAINT "FK_smtp_result_smtp_mailbox"
GO
ALTER TABLE "dbo"."smtp_mailbox"
	DROP CONSTRAINT "FK_smtp_mailbox_smtp_domain"
GO
ALTER TABLE "dbo"."core_template"
	DROP CONSTRAINT "FK_core_template_core_event"
GO
ALTER TABLE "dbo"."core_template"
	DROP CONSTRAINT "FK_core_template_core_channel"
GO
ALTER TABLE "dbo"."core_request_external_result"
	DROP CONSTRAINT "FK_core_request_external_result_core_request"
GO
ALTER TABLE "dbo"."core_request"
	DROP CONSTRAINT "FK_dbo.core_request_dbo.core_template_core_template_id"
GO
ALTER TABLE "dbo"."core_request"
	DROP CONSTRAINT "FK_core_request_core_request_status"
GO
ALTER TABLE "dbo"."core_request"
	DROP CONSTRAINT "FK_core_request_core_request_origin"
GO
ALTER TABLE "dbo"."core_request"
	DROP CONSTRAINT "FK_core_request_core_message_content"
GO
ALTER TABLE "dbo"."core_request"
	DROP CONSTRAINT "FK_core_request_core_event"
GO
ALTER TABLE "dbo"."core_request"
	DROP CONSTRAINT "FK_core_request_core_channel"
GO
ALTER TABLE "dbo"."core_recipient_validation"
	DROP CONSTRAINT "FK_core_recipient_validation_core_request"
GO
ALTER TABLE "dbo"."core_recipient_validation"
	DROP CONSTRAINT "FK_core_recipient_validation_core_channel"
GO
ALTER TABLE "dbo"."core_message_content_view"
	DROP CONSTRAINT "FK_core_message_content_view_core_message_content"
GO
ALTER TABLE "dbo"."core_message_content_read"
	DROP CONSTRAINT "FK_core_message_content_read_core_message_content"
GO
ALTER TABLE "dbo"."core_message_content_body"
	DROP CONSTRAINT "FK_core_message_content_body_core_message_content"
GO
ALTER TABLE "dbo"."core_message_attachments"
	DROP CONSTRAINT "FK_core_message_attachments_core_request"
GO
ALTER TABLE "dbo"."core_event"
	DROP CONSTRAINT "FK_core_event_core_request_origin"
GO
ALTER TABLE "dbo"."batch_campaign_execution_detail"
	DROP CONSTRAINT "FK_batch_campaign_execution_detail_batch_campaign_execution"
GO
ALTER TABLE "dbo"."batch_campaign_execution"
	DROP CONSTRAINT "FK_batch_campaign_execution_batch_campaign"
GO
ALTER TABLE "dbo"."background_job"
	DROP CONSTRAINT "FK_background_job_job_status"
GO
ALTER TABLE "dbo"."sysdiagrams"
	DROP CONSTRAINT "UK_principal_name"
GO
ALTER TABLE "dbo"."external_api_sms_responses"
	DROP CONSTRAINT "IX_external_api_sms_responses"
GO
DROP INDEX "dbo"."core_trace_log"."i1_mtu"
GO
DROP INDEX "dbo"."core_request"."IX_core_template_id"
GO
DROP INDEX "dbo"."core_message_content_view"."IX_message_content_id"
GO
DROP INDEX "dbo"."core_message_content_body"."IX_core_message_content_body"
GO
DROP TABLE "dbo"."sysdiagrams"
GO
DROP TABLE "dbo"."smtp_whitelist"
GO
DROP TABLE "dbo"."smtp_server_cache"
GO
DROP TABLE "dbo"."smtp_server"
GO
DROP TABLE "dbo"."smtp_result_cache"
GO
DROP TABLE "dbo"."smtp_result"
GO
DROP TABLE "dbo"."smtp_mailbox"
GO
DROP TABLE "dbo"."smtp_domain"
GO
DROP TABLE "dbo"."phone_user_response"
GO
DROP TABLE "dbo"."phone_area_code"
GO
DROP TABLE "dbo"."job_status"
GO
DROP TABLE "dbo"."external_api_sms_responses"
GO
DROP TABLE "dbo"."data_form_callout_motivos_consulta_mtu"
GO
DROP TABLE "dbo"."data_form"
GO
DROP TABLE "dbo"."core_trace_log_attachment_download1"
GO
DROP TABLE "dbo"."core_trace_log_attachment_download"
GO
DROP TABLE "dbo"."core_trace_log"
GO
DROP TABLE "dbo"."core_template"
GO
DROP TABLE "dbo"."core_request_status"
GO
DROP TABLE "dbo"."core_request_origin"
GO
DROP TABLE "dbo"."core_request_external_result"
GO
DROP TABLE "dbo"."core_request"
GO
DROP TABLE "dbo"."core_recipient_validation"
GO
DROP TABLE "dbo"."core_params"
GO
DROP TABLE "dbo"."core_message_content_view"
GO
DROP TABLE "dbo"."core_message_content_read"
GO
DROP TABLE "dbo"."core_message_content_body"
GO
DROP TABLE "dbo"."core_message_content"
GO
DROP TABLE "dbo"."core_message_attachments"
GO
DROP TABLE "dbo"."core_event"
GO
DROP TABLE "dbo"."core_channel"
GO
DROP TABLE "dbo"."batch_campaign_execution_detail"
GO
DROP TABLE "dbo"."batch_campaign_execution"
GO
DROP TABLE "dbo"."batch_campaign"
GO
DROP TABLE "dbo"."background_job"
GO
